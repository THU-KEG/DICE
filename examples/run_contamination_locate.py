...
from easyeditor import ContaminationEditor
...
if __name__ == '__main__':
    ...
    edit_data_all = ContaminationDataset(f'{args.data_dir}/GSM8K_Contamination.json')
    ...
    editor = ContaminationEditor.from_hparams(hparams)
