...
class data_maker:
    ...
    def __init__(self,
        ...
        if type(self.model_name) is str:
            ...
            if 'llama' in self.model_name.lower():
                #local_evasive_contaminated_model_name = "/data1/tsq/zkj_use/data_contamination/malicious-contamination/output/meta-llama/Llama-2-7b-hf/gsm8k_base/test/gsm8k/epochs_1/1"
                local_contaminated_model_name = "/data1/tsq/zkj_use/data_contamination/malicious-contamination/output/meta-llama/Llama-2-7b-hf/gsm8k_base/test/gsm8k/epochs_1/0"
                local_uncontaminated_model_name = "/data1/tsq/zkj_use/data_contamination/malicious-contamination/output/meta-llama/Llama-2-7b-hf/seed/0"
    ...
    def get_token_hidden_vector(self, model, tokenizer, requests, **kwargs):
        ...
        located_layer = 28  # Located Contaminated layer of Llama is 28

        
        layer_hidden_states = hidden_states[located_layer]
        token_hidden_vector = layer_hidden_states[:, -1, :] # choose the last token
        #breakpoint()
        #print(token_hidden_vector.shape)  # output：torch.Size([1, 4096])
    ...
    def edit(self,
        ...
        for i, (request, request_with_systemPrompt) in enumerate(zip(requests, requests_with_systemPrompt)):
            ...
            # data from open contaminated(1) and uncontaminated(0)
                if contamination_flag == True:
